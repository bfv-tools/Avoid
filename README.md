...
- In that folder, open the file named "Start.bat"
- In your Battlefield V video settings, switch window mode to Borderless
<br><br>
To edit the list of suspicious clans, just open Blacklist.json in any text editor and where it says "clans": ["CSS", "HL2"] add a comma before the last square bracket, and insert the clan tag you'd like to flag enclosed in quotes ".<br>
For suspicious players, just edit the part below that says      "players": ["Vortigaunt", "Freeman"] and do the same as with the clans except with the player(s) username(s).<br>
For example:<br>
{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"clans": ["CSS", "HL2", "TF2"],<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"players": ["Vortigaunt", "Freeman", "Kleiner"]<br>}
